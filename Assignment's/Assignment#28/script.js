var questions = [
  ...
  var opt1 = document.getElementById("opt1-label");
  var opt2 = document.getElementById("opt2-label");
  var opt3 = document.getElementById("opt3-label");
  ...
  function target() {
    btn.disabled = false;
    var selectedOption = document.querySelector('input[name="option"]:checked').id;
    document.getElementById(selectedOption + "-label").classList.add("option-selected");
}
